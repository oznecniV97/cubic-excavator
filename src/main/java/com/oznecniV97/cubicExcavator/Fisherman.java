...
import com.oznecniV97.cubicExcavator.handler.tickStatus.FishingStatus;
...
public class Fisherman {
	...
	public static Logger log = LogManager.getLogger(Fisherman.class);
	private static Minecraft mc = Minecraft.getMinecraft();
	// singleton instance
	private static Fisherman instance;
	...
	public static Fisherman getInstance() {
		if (instance == null)
			instance = new Fisherman();
		return instance;
	}
	...
	private void inizio() {
		if (exStat.equals(ModStatus.STARTED)) {
			TickStatus.status = new FishingStatus();
			// check strumenti
